...
const MoviePlayer = forwardRef<HTMLDivElement, MoviePlayerProps>(
  ({ movie }, ref) => {
    console.log("MoviePlayer Component Rendered", movie);
    ...
    useEffect(() => {
      console.log("playMovie state changed:", playMovie);
    }, [playMovie]);
    ...
    console.log("Backdrop Image URL:", backdropImage);
