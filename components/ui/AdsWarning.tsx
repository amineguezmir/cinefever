        ...
        <ModalBody>
          <ScrollShadow hideScrollBar className="space-y-4">
            <p className="text-center">
              As our content is hosted by various third party providers, you may
              encounter pop up advertisements while streaming. To improve your
              viewing experience, we suggest using an ad-blocker like{" "}
              <Link
              ...
              . Please be aware that we don't have control over the ads
              displayed and cannot be held responsible for their content or any
